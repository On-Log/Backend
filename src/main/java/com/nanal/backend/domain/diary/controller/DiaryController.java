...
public class DiaryController {
    ...
    @GetMapping("/diary")
    public CommonResponse<RespGetCalendarDto> getCalendar(@Parameter @AuthenticationPrincipal UserDto userDto, @Valid ReqGetCalendarDto reqGetCalendarDto) {
    ...
    @PostMapping("/diary")
    public CommonResponse<?> saveDiary(@Parameter @AuthenticationPrincipal UserDto userDto, @RequestBody @Valid ReqSaveDiaryDto reqSaveDiaryDto) {
    ...
    public CommonResponse<RespGetDiaryDto> getDiary(@Parameter @AuthenticationPrincipal UserDto userDto, ReqGetDiaryDto reqGetDiaryDto) {
    ...
    @PutMapping("/diary")
    public CommonResponse<?> editDiary(@Parameter @AuthenticationPrincipal UserDto userDto, @RequestBody @Valid ReqEditDiaryDto reqEditDiary) {
    ...
    @DeleteMapping("/diary")
    public CommonResponse<?> deleteDiary(@Parameter @AuthenticationPrincipal UserDto userDto, ReqDeleteDiaryDto reqDeleteDiaryDto) {
    ...
    public CommonResponse<RespGetEmotionDto> getEmotion(@Parameter @AuthenticationPrincipal UserDto userDto) {
